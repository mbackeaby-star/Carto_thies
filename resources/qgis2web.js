...
map.getView().fit([-1976397.240081, 1556103.438120, -1617677.515797, 1778876.856195], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Serveur cartographique</h2>';
        return titleElement;
    })(),
